...
const string strMessageMagic = "ForeverCoin Signed Message:\n";
...
static unsigned int GetNextTargetRequired_2(const CBlockIndex* pindexLast, bool fProofOfStake)
{
...
{
        return GetNextTargetRequired_2(pindexLast, fProofOfStake);
}
...
{
    RenameThread("forevercoin-loadblk");
